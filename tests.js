...
expect_equal(lib.is_integer(1.000000000000001), true,
							"is_integer: 1.000000000000001-> true failed")
...
expect_equal(lib.digit_to_string(1), "One", "digit_to_string: 1 -> One failed");
expect_equal(lib.digit_to_string(2), "Two", "digit_to_string: 2 -> Two failed");
expect_equal(lib.digit_to_string(3), "Three", "digit_to_string: 3 -> Three failed");
expect_equal(lib.digit_to_string(4), "Four", "digit_to_string: 4 -> Four failed");
expect_equal(lib.digit_to_string(5), "Five", "digit_to_string: 5 -> Five failed");
expect_equal(lib.digit_to_string(6), "Six", "digit_to_string: 6 -> Six failed");
expect_equal(lib.digit_to_string(7), "Seven", "digit_to_string: 7 -> Seven failed");
expect_equal(lib.digit_to_string(8), "Eight", "digit_to_string: 8 -> Eight failed");
expect_equal(lib.digit_to_string(9), "Nine", "digit_to_string: 9 -> Nine failed");
